...
barplot.data.reviews.contentpos<-barplot(t(data.reviews.contentpos),col = c("forestgreen","antiquewhite2","antiquewhite4","cadetblue","cadetblue4","dodgerblue","dodgerblue3"), legend=colnames(data.reviews.contentpos),beside=TRUE,ylab="content POS distribution in Reviews")

barplot.data.reviews.otherpos<-barplot(t(data.reviews.otherpos),col = c("forestgreen","antiquewhite2","antiquewhite4","cadetblue","cadetblue4","dodgerblue","dodgerblue3"), legend=colnames(data.reviews.otherpos),beside=TRUE,ylab="other POS distribution in Reviews")
...
barplot.data.reviews.t<-barplot(t(data.reviews),horiz=TRUE,col = c("forestgreen","antiquewhite2","antiquewhite4","cadetblue","cadetblue4","dodgerblue","dodgerblue3"), beside=TRUE,xlab="POS distribution",xaxp=c(0,15,10),xlim=range(pretty(c(0, t(data.reviews)))))
legend("right", legend=colnames(data.reviews), pch=15, col=c("forestgreen","antiquewhite2","antiquewhite4","cadetblue","cadetblue4","dodgerblue","dodgerblue3"))
